...
class EditProductsTest {
    ...
    @Test
    void testeditproducts(FxRobot robot) {
        ...
        robot.clickOn("#editproductsbutton");
        assertThat(robot.window("Edit Products")).isShowing();

        robot.clickOn("#Edit");
        assertThat(robot.lookup("#EditMessage").queryText()).hasText("Select an item!");

        robot.type(KeyCode.UP);
        robot.type(KeyCode.ENTER);

        robot.clickOn("#Edit");
        assertThat(robot.window("Edit the product")).isShowing();
